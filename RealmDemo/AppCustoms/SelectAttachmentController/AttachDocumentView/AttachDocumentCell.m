...
- (void)dataDidChange {
    ...
    [self.attachImage setImage:[[UIImage imageNamed:[NSString stringWithFormat:@"ic_%@",attachment.fileName.pathExtension]] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
