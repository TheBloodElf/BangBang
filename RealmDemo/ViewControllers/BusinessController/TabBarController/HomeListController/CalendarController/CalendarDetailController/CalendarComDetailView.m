...
@interface CalendarComDetailView ()<UITableViewDelegate,UITableViewDataSource,ComCalendarTimeDelegate,ComCalendarNameDelegate,ComCalendarInstructionDelegate,ComCalendarAdressDelegate> {
    Calendar *_calendar;
...
@implementation CalendarComDetailView
