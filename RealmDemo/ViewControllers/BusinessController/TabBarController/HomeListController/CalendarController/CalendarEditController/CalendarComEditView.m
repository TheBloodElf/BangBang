...
@interface CalendarComEditView ()<UITableViewDelegate,UITableViewDataSource,ComCalendarTimeDelegate,ComCalendarNameDelegate,ComCalendarInstructionDelegate,ComCalendarAdressDelegate> {
    Calendar *_calendar;
    UITableView *_tableView;
}
@end

@implementation CalendarComEditView
