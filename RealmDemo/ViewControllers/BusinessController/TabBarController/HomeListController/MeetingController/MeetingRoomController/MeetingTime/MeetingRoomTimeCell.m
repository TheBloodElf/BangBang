...
- (void)createLineDate {
    ...
    if(currWeek == 7) {
        ...
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:6 * 24 * 60 * 60] forKey:@"7"];
    }
    if(currWeek == 1) {
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-24 * 60 * 60] forKey:@"1"];
        [_lineDate setValue:_currWeekDate forKey:@"2"];
        ...
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:5 * 24 * 60 * 60] forKey:@"7"];
    }
    if(currWeek == 2) {
        ...
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:4 * 24 * 60 * 60] forKey:@"7"];
    }
    if(currWeek == 3) {
        ...
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:3 * 24 * 60 * 60] forKey:@"7"];
    }
    if(currWeek == 4) {
        ...
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:1 * 24 * 60 * 60] forKey:@"6"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:2 * 24 * 60 * 60] forKey:@"7"];
    }
    if(currWeek == 5) {
        ...
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-2 * 24 * 60 * 60] forKey:@"4"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:- 24 * 60 * 60] forKey:@"5"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:0] forKey:@"6"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval: 24 * 60 * 60] forKey:@"7"];
    }
    if(currWeek == 6) {
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-6 * 24 * 60 * 60] forKey:@"1"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-5 * 24 * 60 * 60] forKey:@"2"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-4 * 24 * 60 * 60] forKey:@"3"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-3 * 24 * 60 * 60] forKey:@"4"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-2 * 24 * 60 * 60] forKey:@"5"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:-1 * 24 * 60 * 60] forKey:@"6"];
        [_lineDate setValue:[_currWeekDate dateByAddingTimeInterval:0] forKey:@"7"];
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    //当前行的时间
    NSDate *currDate = _lineDate[[NSString stringWithFormat:@"%d",indexPath.section + 1]];
    //求出这一列的时间
    ...
    cell.delegate = self;
    cell.userSelectDate = _userSelectDate;
    cell.data = model;
    return cell;
}
