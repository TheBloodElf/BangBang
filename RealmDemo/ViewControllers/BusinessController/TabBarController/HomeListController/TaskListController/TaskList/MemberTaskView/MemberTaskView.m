...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _inchargeFetchedResultsController = [_userManager createMemberTaskFetchedResultsController:_userManager.user.currCompany.company_no];
